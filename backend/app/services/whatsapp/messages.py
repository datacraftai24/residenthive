...
class MessageBuilder:
    ...
    def report_approval_request(
        ...
        """
        Ask agent to approve or reject sending a report to the buyer.
        """
        body = (
            f"📄 *Report ready for {buyer_name}*\n\n"
            f"🔗 {share_url}\n\n"
            f"Includes {listing_count} properties with AI analysis.\n\n"
            "Approve to email the report to the buyer, or reject to discard."
        )
        return MessageBuilder.buttons(
            body=body,
            buttons=[
